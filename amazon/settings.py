...
SECRET_KEY = 'django-insecure-r)2hgvv)8#*=28d6f3re4hpw_+@ev#&2^0who%5rl#dbcep9)f'
...
CELERY_BEAT_SCHEDULE = {
    'scrape-amazon-products-every-6-hours': {
        ...
        # 'schedule': crontab(minute='*/1'), # use this for testing purposes
    },
}
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'scraping.log'),
            'formatter': 'verbose',
        },
        'console': {
